(function () {
            ...
            $("body .animate-box.item-animate").each(function (k) {
              ...
              setTimeout(
                function () {
                  ...
                  el.addClass((effect || "fadeInUp") + " animated").removeClass(
                    "item-animate",
                  );
                },
                k * 200,
  ...
  var pubFilter = function () {
    ...
    $btns
      ...
      .append(' <span class="count">' + total + "</span>");
    $btns
      .filter('[data-filter="psu"]')
      .append(' <span class="count">' + psu + "</span>");
  };
  ...
  var newsToggle = function () {
    $(".news-toggle").on("click", function (e) {
      ...
      $(this)
        .data("open", !open)
        .text(open ? $(this).data("more") : $(this).data("less"));
    });
  };
